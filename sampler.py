...
def make_beta_schedule(schedule='linear',num_timesteps=1000,linear_start=0.0001,linear_end=0.02,cosine_s=0.01):
    ...
    if schedule=='linear':
        ...
        print("Why would you NOT want a scheduler !!! You don't want the model to work ?")
        betas = None
...
class DDIMSampler():
    ...
    def __init__(self,diff_timesteps,inf_timesteps,eta=0.0,beta_start=0.0001,beta_end=0.02,
        ...
        self.betas = make_beta_schedule(var_schedule,diff_timesteps,beta_start,beta_end,cosine_s)
